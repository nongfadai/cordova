...
<% if(count<1){%>
    ...
    <div class="wx_recharge wx_recharge3"  id="recharge">
      <div class="wx_account_table2 ttn-lcr">
        ...
        <a href="/weixin/account/send/index" class="wx_btn_org wx-black-index" id="drawIndex">返回账户总览（<ins left_time_int="5">5</ins>）</a>
      </div>
    </div>
<% }else if(count==1){
...
<% }else if(count>1){%>
    ...
    <div class="ttn-more-blank">
      ...
      <a href="/weixin/account/send/index" class="wx_btn_org wx-black-index" id="drawIndex">返回账户总览（<ins left_time_int="500">5500</ins>）</a>
    </div>
<%}%>
