...
<form action='../../../lib/complie/weChat/wx_regtwo.do' method="post" name="pageform" id="pageform">
    <div class="input-box">
    ...
    <div class="input-check">
      ...
      <span class="input-check-img input-checked-img"></span> 我已阅读并同意<a href="../../../lib/complie/terms.html" class="wx_blue" id="wxTerms"> 《使用条款》</a>和<a href="../../../lib/complie/terms_privacy.html" class="wx_blue"  id="wxTermsPrivacy">《隐私条款》</a>
  	</div>
</form>
</div>
<div class="register-form2" style="display:none;">
     <div class='wx_step2_tip'>已向您的手机 <span id='phone'></span> 发送短信，请输入您收到的验证码。</div>
     <form action='../../../lib/complie/weChat/wx_reglast.do' method="post" name="pageform" id="pageform2">
...
<div class="wx_register-ok" id="registerOK"  style="display:none">
	...
	<a href="../../../lib/complie/list.html#axn" class="wx_btn_org">浏览产品列表 (<span id="registerOkCountdown" left_time_int="5">5</span>)</a>
